...
public class fullheadsetright extends ActionBarActivity {
    //private final static Logger LOGGER = Logger.getLogger(fullheadsetright.class.getName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rightheadset);
        ...
        leftvolumelevel.setOnClickListener(new View.OnClickListener() {//after confirming the left ear volume level
            ...
            public void onClick(View v) {//after confirming the left ear volume level
                ...
                Intent soundprof = new Intent(fullheadsetright.this, soundprofile.class);
