...
public class playmusic extends ActionBarActivity {
    ...
    private final static Logger LOGGER = Logger.getLogger(playmusic.class.getName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String value = getIntent().getStringExtra("path");
        tx1 = (TextView) findViewById(R.id.textView2);
        tx2 = (TextView) findViewById(R.id.textView3);
        tx3 = (TextView) findViewById(R.id.textView4);
        tx3.setText(getIntent().getStringExtra("songname") + ".mp3");
