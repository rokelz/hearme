 ...
 */
public class retakeleft extends ActionBarActivity {

    private static String LEFT_VOLUME_LEVEL;
    private static String reprofName, reprofid;
    ...
    //private final static Logger LOGGER = Logger.getLogger(retakeleft.class.getName());
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_retakeleft);
        getSupportActionBar().hide();
        reprofName = getIntent().getStringExtra("retakeprofname");
        ...
        leftvolumelevel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {//after confirming the left ear volume level
                ...
                Intent rightheadset = new Intent(retakeleft.this, retakeright.class);
                rightheadset.putExtra("keyName", LEFT_VOLUME_LEVEL);
                rightheadset.putExtra("retakeprofname", reprofName);
                rightheadset.putExtra("retakeprofid", reprofid);
