 ...
 */
public class btheadsetright extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rightbt);
        ...
        leftvolumelevel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {//after confirming the left ear volume level
                ...
                System.out.println(HEADSET);
                Intent rightheadset = new Intent(btheadsetright.this, soundprofile.class);
                rightheadset.putExtra("left", headsetvalu);
                rightheadset.putExtra("right", LEFT_VOLUME_LEVEL);
